...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
		...
		bool isTradeAccepted() const { return m_trade->IsAccepted(); }
		...
		/***                     BOT SYSTEM                    ***/
		/*********************************************************/
		Player *GetObjPlayer (uint64 guid) const;
		...
		bool IsPlayerbot() const { return(this->GetSession()->GetRemoteAddress() == "bot"); }
