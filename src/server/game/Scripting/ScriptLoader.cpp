...
void AddSC_boss_tc_alliance_champions();                           // Alliance Champs
void AddSC_boss_anubarak_trial();                                  // Anubarak
void AddSC_boss_lord_jaraxxus();                                   // Jaraxxus
void AddSC_boss_northrend_beasts();                                // Northrend Beasts
void AddSC_boss_twin_valkyr();                                     // Twin Valkyr
void AddSC_boss_tc_horde_champions();                              // Horde Champions
void AddSC_instance_trial_of_the_crussader();
void AddSC_trial_of_the_crussader();

/* Add on NPCS */
void AddSC_pryds_telenpc();                                        // Buff npc                                              
void AddSC_Npc_Buff();                                             // Buff npc
void AddSC_item_custom_summon();                                   // Item summoner
void AddSC_AllInOne();                                             // All in One
void AddSC_guildmaster();                                          // Guild master
void AddSC_professionnpc();										   // Professions Master 
...
void AddScripts()
{
	...
	/* Trial of the Crusader */
	AddSC_boss_tc_alliance_champions();                           // Alliance Champs
	AddSC_boss_anubarak_trial();                                  // Anubarak
	AddSC_boss_lord_jaraxxus();                                   // Jaraxxus
	AddSC_boss_northrend_beasts();                                // Northrend Beasts
	AddSC_boss_twin_valkyr();                                     // Twin Valkyr
	AddSC_boss_tc_horde_champions();                              // Horde Champions
	...
	AddSC_pryds_telenpc();                                        // Buff npc 
    AddSC_Npc_Buff();                                             // Buff npc
	AddSC_item_custom_summon();                                   // Item summoner
	AddSC_AllInOne();                                             // All in One
	AddSC_guildmaster();                                          // Guild master
	AddSC_professionnpc();										  // Professions Master
	AddSC_item_custom_stone();                                    // Item - Talents + 1
