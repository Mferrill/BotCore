...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
	...
	LANG_BG_IC_START_TWO_MINUTES        = 1334,
    LANG_BG_IC_START_ONE_MINUTE         = 1335,
    LANG_BG_IC_START_HALF_MINUTE        = 1336,
	LANG_BG_IC_HAS_BEGUN       			= 1337,
	LANG_BG_IC_NODE_HANGAR				= 1338,
	LANG_BG_IC_NODE_QUARRY				= 1339,
	LANG_BG_IC_NODE_REFINERY			= 1340,
	LANG_BG_IC_NODE_DOCKS				= 1341,
	LANG_BG_IC_NODE_WORKSHOP			= 1342,
	LANG_BG_IC_NODE_TAKEN				= 1343,	
	LANG_BG_IC_HORDE					= 1344,
	LANG_BG_IC_ALLY						= 1345,
	LANG_BG_IC_NODE_CLAIMED				= 1346,
	LANG_BG_IC_NODE_DEFENDED			= 1347,	
	LANG_BG_IC_NODE_ASSAULTED			= 1348,
    // FREE IDS                           1348-1999
